// this is for the frontend users 
...
export const ADVERTISE_PRODUCTS_REQUEST = 'ADVERTISE_PRODUCTS_REQUEST'
export const ADVERTISE_PRODUCTS_SUCCESS = 'ADVERTISE_PRODUCTS_SUCCESS'
export const ADVERTISE_PRODUCTS_FAIL = 'ADVERTISE_PRODUCTS_FAIL'
